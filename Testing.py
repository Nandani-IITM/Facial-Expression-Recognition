...
while True:
    ...
    if not ret:
        break
    face_detector = cv2.CascadeClassifier('E:/Nandani_D22180/Emotion_detection_with_CNN-main/Emotion_detection_with_CNN-main/haarcascades/haarcascade_frontalface_default.xml')
